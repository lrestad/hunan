...
struct TextRenderer {
    ...
    TextRenderer() : shader(data_path("text.vs").c_str(), data_path("text.fs").c_str()) {};
    TextRenderer(std::string font_name)  : 
            shader(data_path("text.vs").c_str(), data_path("text.fs").c_str()) {
        // OpenGL State
